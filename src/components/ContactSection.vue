<template>
    <section class="text-white mt-20" id="contact">
        ...
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                <p class="text-[#adb7be]">I’m always excited to connect with new people and explore potential collaborations! If you have any questions, feedback, or opportunities, feel free to reach out.
                </p>
                <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>LinkedIn</h4>
                            <p>https://www.linkedin.com/in/rahulyadav9861/</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form class="flex flex-col p-2" data-aos="zoom-in-up" >
                ...
                <div class="mb-6">
                    <label for="Mobile Number" class="text-white block mb-2 text-sm font-medium">Mobile Number</label>
                    <input type="Mobile Number" id="Mobile Number" class="bg-[#111827] placeholder:[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
